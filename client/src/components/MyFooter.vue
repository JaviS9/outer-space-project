<template>
  <footer class="p-2 border-top border-2 m-0">
      ...
      <div class="row d-flex justify-content-center align-items-center text-center mx-5 my-0 border-top p-0">
        <router-link v-if="status.admin === true" to="/manager" class="p-2 nav-link active d-flex align-items-center justify-content-center" aria-current="page">
        ...
        <router-link v-if="status.public === true" to="/" class="p-2 nav-link active d-flex align-items-center justify-content-center" aria-current="page">
