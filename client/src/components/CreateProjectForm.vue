    ...
    <div class="modal-dialog">
      <div class="modal-content bg-black border border-2 text-white p-3">
        <div class="modal-header">
          ...
          <button id="closeForm" type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">
              ...
              <div class="col-md-7">
                <form autocomplete="off">
                  ...
                  <div class="col-8 d-flex align-items-center justify-content-start">
                    <p class="m-0 h0">Financiación: </p>
                    <input type="number" min="1" step="any" class="form-control ms-2" placeholder="0,00" v-model="financiation">
